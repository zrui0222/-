...
class SGDSNR(Optimizer):
    ...
    def __init__(self, params, lr=required, momentum=0, dampening=0,
                 weight_decay=0, nesterov=False, spectrum_regularization=0, differentiable: bool = False,
                 epoch=1,
                 stage_epoch=0):
    ...
    def __setstate__(self, state):
        ...
        for group in self.param_groups:
            ...
            group.setdefault('epoch', 1)
            group.setdefault('stage_epoch', 0)
            ...
            for p in group['params']:
                ...
                if epoch < stage_epoch:
                    ...
                    if spectrum_regularization != 0:
                        #print("spectrum_regularization", spectrum_regularization, epoch, stage_epoch, p.dim())
                        if p.dim() > 1:
